...
FUNCIONES MÍNIMAS POR IMPLEMENTAR
•	agregar_carta(cartas: dict, codigo: str, datos: list) -> bool 
•	usar_carta(cartas: dict, codigo: str, gasto: int) -> bool 
•	listar_cartas(cartas: dict) -> None 
•	cartas_con_poca_energia(cartas: dict, umbral: int) -> None
